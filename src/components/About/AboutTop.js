        ...
        <div>
            <Row className="mt-5 mx-auto w-75">
                <Col xs={12} sm={12} md={7} lg={7}>
                    <div className="mt-5">
                        <h2 className="text-warning mb-3 fw-bold">Angel's care child home</h2>
                        <h2 className="text-info mb-3 fw-bold">The Best Fertility Center in Bangladesh</h2>
                    </div>
                    <div className="me-5">
                        <p>
                            Angel's care child home is a top-rated fertility centre in Bangladesh dedicated to helping childless couples to build families. We take pride in calling ourselves the best fertility hospital in Bangladesh with the most effective IVF treatment. Over 45,000+ IVF/ICSI babies delivered worldwide. Schedule your Appointment Today.
                        </p>

                        <p>
                            Angel's care child home has centralized laboratory facilities for IVF treatment. Our fertility specialists have extensive expertise in treating all types of fertility from basic to complex fertility services.
                        </p>
